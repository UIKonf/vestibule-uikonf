class ApplicationController < ActionController::Base
  ...
  def set_archive_mode_warning_if_required
    if Vestibule.mode_of_operation.mode == :archive
      flash.now[:archive] = 'This version of Vestibule is <em>read only</em>. It represents an archive of the community effort to produce content for <a href="http://www.uikonf.com/">UIKonf 2016</a>.'.html_safe
    end
